...
export default function navigationBar (){
    ...
    return (
        <div className=" flex navbar justify-center content-center">
            <div className="flex space-x-8 w-fit">
                <div className="flex-1 text-navGreyText">
                    <Link href="/Dashboard"
                          className="btn btn-ghost text-xl hover:bg-navHover hover:text-whitePuro font-poppins font-normal text-18">Home</Link>
                </div>
                <div className="flex-1 text-navGreyText">
                    <Link href="/Dashboard/Watchlist"
                          className="btn btn-ghost text-xl hover:bg-navHover hover:text-whitePuro font-poppins font-normal text-18">WatchList</Link>
                </div>
                <div className="flex-1 text-navGreyText">
                    <Link href="/Dashboard/Like"
                          className="btn btn-ghost text-xl hover:bg-navHover hover:text-whitePuro font-poppins font-normal text-18">Like</Link>
                </div>
                <div className="flex-1 text-navGreyText">
                    <Link href="/Dashboard/Recommender"
                          className="btn btn-ghost text-xl hover:bg-navHover hover:text-whitePuro font-poppins font-normal text-18">Recommender</Link>
                </div>
            </div>
            <div className="flex-none gap-2 absolute right-0 pr-20">
                <div className="dropdown dropdown-left">
                    <div tabIndex={0} role="button" className="btn btn-ghost btn-circle hover:bg-navHover">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             className="h-5 w-5 hover:text-whitePuro text-navGreyText" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor">
                    ...
                    <div tabIndex={0}
                         className="form-control menu menu-sm dropdown-content">
                        <SearchBar/>
                    </div>
                </div>
                    ...
                    <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
                        <div className="w-10 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision"
                                 ...
                                 fillRule="evenodd" clipRule="evenodd" viewBox="0 0 494 511.5">
                                <path fill="#D9E9F0" fillRule="nonzero"
                                ...
                                <path fill="#194794" fillRule="nonzero"
                                ...
                                <path fill="#D2A75F" fillRule="nonzero"
                                ...
                                <path fill="#DBB26F" fillRule="nonzero"
